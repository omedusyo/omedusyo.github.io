...
var $author$project$Main$Model = F3(
	function (ct, ht, dt) {
		return {ct: ct, dt: dt, ht: ht};
	});
var $author$project$Main$initModel = A3($author$project$Main$Model, 0, 0, 0);
...
var $author$project$Main$base = 50;
...
var $author$project$Main$im = function (z) {
	return z.im;
};
var $author$project$Main$re = function (z) {
	return z.re;
};
var $author$project$Main$size = 5;
var $author$project$Main$complexShape = function (z) {
	return A2(
		$joakin$elm_canvas$Canvas$circle,
		_Utils_Tuple2(
			$author$project$Main$centerX + ($author$project$Main$base * $author$project$Main$re(z)),
			$author$project$Main$centerY - ($author$project$Main$base * $author$project$Main$im(z))),
		$author$project$Main$size);
};
var $author$project$Main$ChangeComplex = function (a) {
	return {$: 'ChangeComplex', a: a};
};
...
var $author$project$Main$complexSlider = function (t0) {
	return $carwow$elm_slider$SingleSlider$init(
		{
			max: (2 * 2) * 3.1415,
			min: 0,
			onChange: function (t) {
				return $author$project$Main$ChangeComplex(t);
			},
			step: 0.2,
			value: t0
		});
};
var $author$project$Main$dim = function (z) {
	return z.dim;
};
var $author$project$Main$Dual = F2(
	function (dre, dim) {
		return {dim: dim, dre: dre};
	});
var $author$project$Main$dmake = F2(
	function (a, b) {
		return A2($author$project$Main$Dual, a, b);
	});
var $author$project$Main$dre = function (z) {
	return z.dre;
};
var $author$project$Main$dmul = F2(
	function (z, w) {
		var d = $author$project$Main$dim(w);
		var c = $author$project$Main$dre(w);
		var b = $author$project$Main$dim(z);
		var a = $author$project$Main$dre(z);
		return A2($author$project$Main$dmake, a * c, (a * d) + (b * c));
	});
var $author$project$Main$dsquare = function (z) {
	return A2($author$project$Main$dmul, z, z);
};
var $author$project$Main$dexppow = F2(
	function (z, n) {
		return (!n) ? z : $author$project$Main$dsquare(
			A2($author$project$Main$dexppow, z, n - 1));
	});
var $elm$core$Basics$pow = _Basics_pow;
var $author$project$Main$dexp = F3(
	function (d, t, n) {
		return A2(
			$author$project$Main$dexppow,
			A2(
				$author$project$Main$dmake,
				1,
				(d * t) / A2($elm$core$Basics$pow, 2, n)),
			n);
	});
var $elm$html$Html$div = _VirtualDom_node('div');
var $author$project$Main$dualShape = function (z) {
	return A2(
		$joakin$elm_canvas$Canvas$circle,
		_Utils_Tuple2(
			$author$project$Main$centerX + ($author$project$Main$base * $author$project$Main$dre(z)),
			$author$project$Main$centerY - ($author$project$Main$base * $author$project$Main$dim(z))),
		$author$project$Main$size);
};
var $author$project$Main$ChangeDual = function (a) {
	return {$: 'ChangeDual', a: a};
};
var $elm$core$Basics$negate = function (n) {
	return -n;
};
var $author$project$Main$dualSlider = function (t0) {
	return $carwow$elm_slider$SingleSlider$init(
		{
			max: 7,
			min: -7,
			onChange: function (t) {
				return $author$project$Main$ChangeDual(t);
			},
			step: 0.1,
			value: t0
		});
};
var $author$project$Main$Complex = F2(
	function (re, im) {
		return {im: im, re: re};
	});
var $author$project$Main$make = F2(
	function (a, b) {
		return A2($author$project$Main$Complex, a, b);
	});
var $author$project$Main$mul = F2(
	function (z, w) {
		var d = $author$project$Main$im(w);
		var c = $author$project$Main$re(w);
		var b = $author$project$Main$im(z);
		var a = $author$project$Main$re(z);
		return A2($author$project$Main$make, (a * c) - (b * d), (a * d) + (b * c));
	});
var $author$project$Main$square = function (z) {
	return A2($author$project$Main$mul, z, z);
};
var $author$project$Main$exppow = F2(
	function (z, n) {
		return (!n) ? z : $author$project$Main$square(
			A2($author$project$Main$exppow, z, n - 1));
	});
var $author$project$Main$exp = F3(
	function (d, t, n) {
		return A2(
			$author$project$Main$exppow,
			A2(
				$author$project$Main$make,
				1,
				(d * t) / A2($elm$core$Basics$pow, 2, n)),
			n);
	});
...
var $author$project$Main$him = function (z) {
	return z.him;
};
var $author$project$Main$Hyperbolic = F2(
	function (hre, him) {
		return {him: him, hre: hre};
	});
var $author$project$Main$hmake = F2(
	function (a, b) {
		return A2($author$project$Main$Hyperbolic, a, b);
	});
var $author$project$Main$hre = function (z) {
	return z.hre;
};
var $author$project$Main$hmul = F2(
	function (z, w) {
		var d = $author$project$Main$him(w);
		var c = $author$project$Main$hre(w);
		var b = $author$project$Main$him(z);
		var a = $author$project$Main$hre(z);
		return A2($author$project$Main$hmake, (a * c) + (b * d), (a * d) + (b * c));
	});
var $author$project$Main$hsquare = function (z) {
	return A2($author$project$Main$hmul, z, z);
};
var $author$project$Main$hexppow = F2(
	function (z, n) {
		return (!n) ? z : $author$project$Main$hsquare(
			A2($author$project$Main$hexppow, z, n - 1));
	});
var $author$project$Main$hexp = F3(
	function (d, t, n) {
		return A2(
			$author$project$Main$hexppow,
			A2(
				$author$project$Main$hmake,
				1,
				(d * t) / A2($elm$core$Basics$pow, 2, n)),
			n);
	});
var $author$project$Main$hyperbolicShape = function (z) {
	return A2(
		$joakin$elm_canvas$Canvas$circle,
		_Utils_Tuple2(
			$author$project$Main$centerX + ($author$project$Main$base * $author$project$Main$hre(z)),
			$author$project$Main$centerY - ($author$project$Main$base * $author$project$Main$him(z))),
		$author$project$Main$size);
};
var $author$project$Main$ChangeHyperbolic = function (a) {
	return {$: 'ChangeHyperbolic', a: a};
};
var $author$project$Main$hyperbolicSlider = function (t0) {
	return $carwow$elm_slider$SingleSlider$init(
		{
			max: 3,
			min: -3,
			onChange: function (t) {
				return $author$project$Main$ChangeHyperbolic(t);
			},
			step: 0.025,
			value: t0
		});
};
var $author$project$Main$zero = A2($author$project$Main$make, 0, 0);
var $author$project$Main$originShape = $author$project$Main$complexShape($author$project$Main$zero);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Exponential maps of Rotational (Complex), Hyperbolic, Dual Numbers')
					])),
				A3(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[$author$project$Main$originShape])),
						A2(
						$joakin$elm_canvas$Canvas$shapes,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$author$project$Main$complexShape(
								A3($author$project$Main$exp, 1, model.ct, n))
							])),
						A2(
						$joakin$elm_canvas$Canvas$shapes,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$author$project$Main$hyperbolicShape(
								A3($author$project$Main$hexp, 1, model.ht, n))
							])),
						A2(
						$joakin$elm_canvas$Canvas$shapes,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$author$project$Main$dualShape(
								A3($author$project$Main$dexp, 1, model.dt, n))
							]))
					])),
				$carwow$elm_slider$SingleSlider$view(
				$author$project$Main$complexSlider(model.ct)),
				$carwow$elm_slider$SingleSlider$view(
				$author$project$Main$hyperbolicSlider(model.ht)),
				$carwow$elm_slider$SingleSlider$view(
				$author$project$Main$dualSlider(model.dt))
			]));
};
