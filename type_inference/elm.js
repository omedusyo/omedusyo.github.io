...
var $author$project$Evaluation$emptyTermEnvironment = $pzp1997$assoc_list$AssocList$empty;
var $author$project$Evaluation$Closure = function (a) {
	return {$: 'Closure', a: a};
};
var $author$project$Evaluation$ConsValue = F2(
	function (a, b) {
		return {$: 'ConsValue', a: a, b: b};
	});
var $author$project$Evaluation$EmptyListValue = {$: 'EmptyListValue'};
...
var $author$project$Evaluation$FalseValue = {$: 'FalseValue'};
var $author$project$Evaluation$LeftValue = function (a) {
	return {$: 'LeftValue', a: a};
};
var $author$project$Evaluation$ListValue = function (a) {
	return {$: 'ListValue', a: a};
};
var $author$project$Evaluation$NatSuccValue = function (a) {
	return {$: 'NatSuccValue', a: a};
};
var $author$project$Evaluation$NatValue = function (a) {
	return {$: 'NatValue', a: a};
};
var $author$project$Evaluation$NatZeroValue = {$: 'NatZeroValue'};
var $author$project$Evaluation$PairValue = F2(
	function (a, b) {
		return {$: 'PairValue', a: a, b: b};
	});
var $author$project$Evaluation$RightValue = function (a) {
	return {$: 'RightValue', a: a};
};
var $author$project$Evaluation$TrueValue = {$: 'TrueValue'};
...
var $author$project$Evaluation$extendEnvironment = F3(
...
var $author$project$Evaluation$lookupEnvironment = F2(
	function (varName, env) {
		var _v0 = A2($pzp1997$assoc_list$AssocList$get, varName, env);
		if (_v0.$ === 'Just') {
			var terms = _v0.a;
			if (!terms.b) {
				return $elm$core$Maybe$Nothing;
...
var $author$project$Evaluation$eval = F2(
	function (env, term) {
		_eval:
		while (true) {
			switch (term.$) {
				case 'VarUse':
					var varName = term.a;
					var _v1 = A2($author$project$Evaluation$lookupEnvironment, varName, env);
					if (_v1.$ === 'Just') {
						var result = _v1.a;
				...
				case 'Pair':
					var fst = term.a;
					var snd = term.b;
					var evaledSndResult = A2($author$project$Evaluation$eval, env, snd);
					var evaledFstResult = A2($author$project$Evaluation$eval, env, fst);
					var _v2 = _Utils_Tuple2(evaledFstResult, evaledSndResult);
					if (_v2.a.$ === 'Ok') {
						if (_v2.b.$ === 'Ok') {
							var evaledFst = _v2.a.a;
							var evaledSnd = _v2.b.a;
							return $elm$core$Result$Ok(
								A2($author$project$Evaluation$PairValue, evaledFst, evaledSnd));
						} else {
							var evaledFst = _v2.a.a;
							var errSnd = _v2.b.a;
							return $elm$core$Result$Err(errSnd);
						}
					} else {
						if (_v2.b.$ === 'Ok') {
							var errFst = _v2.a.a;
							var evaledSnd = _v2.b.a;
							return $elm$core$Result$Err(errFst);
						} else {
							var errFst = _v2.a.a;
							var errSnd = _v2.b.a;
							return $elm$core$Result$Err(
								_Utils_ap(errFst, errSnd));
						}
					}
				case 'MatchProduct':
					var arg = term.a.arg;
					...
					return A2(
						...
						function (argEvaled) {
							if (argEvaled.$ === 'PairValue') {
								...
								var newEnv = A3(
									$author$project$Evaluation$extendEnvironment,
									var1,
									val1,
									A3($author$project$Evaluation$extendEnvironment, var0, val0, env));
								return A2($author$project$Evaluation$eval, newEnv, body);
							} else {
								return $elm$core$Result$Err(
									_List_fromArray(
						...
						A2($author$project$Evaluation$eval, env, arg));
				case 'Abstraction':
					var _var = term.a;
					var body = term.b;
					return $elm$core$Result$Ok(
						$author$project$Evaluation$Closure(
							{body: body, env: env, _var: _var}));
				case 'Application':
					var fn = term.a;
					var arg = term.b;
					var fnEvaledResult = A2($author$project$Evaluation$eval, env, fn);
					if (fnEvaledResult.$ === 'Ok') {
						if (fnEvaledResult.a.$ === 'Closure') {
							var closure = fnEvaledResult.a.a;
							var _var = closure._var;
							var body = closure.body;
							var argEvaledResult = A2($author$project$Evaluation$eval, env, arg);
							if (argEvaledResult.$ === 'Ok') {
								var argEvaled = argEvaledResult.a;
								var newEnv = A3($author$project$Evaluation$extendEnvironment, _var, argEvaled, closure.env);
								var $temp$env = newEnv,
									$temp$term = body;
								env = $temp$env;
								term = $temp$term;
						...
						var err = fnEvaledResult.a;
						return $elm$core$Result$Err(err);
					}
				case 'Left':
					var term1 = term.a;
					var evaledTermResult = A2($author$project$Evaluation$eval, env, term1);
					if (evaledTermResult.$ === 'Ok') {
						var evaledTerm = evaledTermResult.a;
						return $elm$core$Result$Ok(
							$author$project$Evaluation$LeftValue(evaledTerm));
					} else {
						var err = evaledTermResult.a;
						return $elm$core$Result$Err(err);
					}
				case 'Right':
					var term1 = term.a;
					...
					if (evaledTermResult.$ === 'Ok') {
						var evaledTerm = evaledTermResult.a;
						return $elm$core$Result$Ok(
							$author$project$Evaluation$RightValue(evaledTerm));
					} else {
						var err = evaledTermResult.a;
						return $elm$core$Result$Err(err);
					}
				case 'Case':
					...
					if (argEvaledResult.$ === 'Ok') {
						...
						switch (argEvaled.$) {
							case 'LeftValue':
								var val = argEvaled.a;
								var newEnv = A3($author$project$Evaluation$extendEnvironment, leftVar, val, env);
								var $temp$env = newEnv,
									$temp$term = leftBody;
								env = $temp$env;
								term = $temp$term;
							...
							case 'RightValue':
								var val = argEvaled.a;
								var newEnv = A3($author$project$Evaluation$extendEnvironment, rightVar, val, env);
								var $temp$env = newEnv,
									$temp$term = rightBody;
								env = $temp$env;
								term = $temp$term;
						...
						var errs = argEvaledResult.a;
						return $elm$core$Result$Err(errs);
					}
				case 'BoolTrue':
					return $elm$core$Result$Ok($author$project$Evaluation$TrueValue);
				case 'BoolFalse':
					return $elm$core$Result$Ok($author$project$Evaluation$FalseValue);
				case 'IfThenElse':
					var arg = term.a;
					var leftBody = term.b;
				...
				case 'NatZero':
					return $elm$core$Result$Ok(
						$author$project$Evaluation$NatValue($author$project$Evaluation$NatZeroValue));
				case 'NatSucc':
					var term1 = term.a;
					var term1EvaledResult = A2($author$project$Evaluation$eval, env, term1);
					if (term1EvaledResult.$ === 'Ok') {
						var argEvaled = term1EvaledResult.a;
						if (argEvaled.$ === 'NatValue') {
							var natVal = argEvaled.a;
							return $elm$core$Result$Ok(
								$author$project$Evaluation$NatValue(
									$author$project$Evaluation$NatSuccValue(natVal)));
						} else {
							return $elm$core$Result$Err(
								_List_fromArray(
						...
						if (argEvaled.$ === 'NatValue') {
							...
							var evalNatLoop = function (natVal0) {
								if (natVal0.$ === 'NatZeroValue') {
									return A2($author$project$Evaluation$eval, env, base);
								} else {
									var natVal1 = natVal0.a;
									var prevResult = evalNatLoop(natVal1);
									if (prevResult.$ === 'Ok') {
										var prevVal = prevResult.a;
										var newEnv = A3(
											$author$project$Evaluation$extendEnvironment,
											loop.stateVar,
											prevVal,
											A3(
												$author$project$Evaluation$extendEnvironment,
												loop.indexVar,
												$author$project$Evaluation$NatValue(natVal1),
												env));
										return A2($author$project$Evaluation$eval, newEnv, loop.body);
									} else {
										var errs = prevResult.a;
										return $elm$core$Result$Err(errs);
									}
								}
							};
				...
				case 'EmptyList':
					return $elm$core$Result$Ok(
						$author$project$Evaluation$ListValue($author$project$Evaluation$EmptyListValue));
				case 'Cons':
					var headTerm = term.a;
					var tailTerm = term.b;
					return A2(
						...
						function (headValue) {
							return A2(
								...
								function (tailValue) {
									return $elm$core$Result$Ok(
										$author$project$Evaluation$ListValue(
											A2($author$project$Evaluation$ConsValue, headValue, tailValue)));
								},
								A2($author$project$Evaluation$eval, env, tailTerm));
						},
						A2($author$project$Evaluation$eval, env, headTerm));
				default:
											...
											return A2(
												...
												function (prevVal) {
													var newEnv = A3(
														...
														loop.stateVar,
														prevVal,
														A3($author$project$Evaluation$extendEnvironment, loop.listElementVar, headValue, env));
													return A2($author$project$Evaluation$eval, newEnv, loop.body);
												},
												prevResult);
										} else {
...
var $author$project$Evaluation$eval0 = function (term) {
	return A2($author$project$Evaluation$eval, $author$project$Evaluation$emptyTermEnvironment, term);
};
var $author$project$Inference$emptyContext = $pzp1997$assoc_list$AssocList$empty;
var $author$project$Inference$emptyEquations = $pzp1997$assoc_list$AssocList$empty;
var $author$project$Inference$emptyState = {context: $author$project$Inference$emptyContext, equations: $author$project$Inference$emptyEquations, nextTypeVar: 0};
var $author$project$LambdaBasics$Arrow = F2(
	function (a, b) {
		return {$: 'Arrow', a: a, b: b};
	});
var $author$project$Inference$ExpectedArrowType = {$: 'ExpectedArrowType'};
var $author$project$Inference$ExpectedListType = {$: 'ExpectedListType'};
var $author$project$Inference$ExpectedSumType = {$: 'ExpectedSumType'};
...
var $author$project$Inference$newTypeVar = function (n) {
	return _Utils_Tuple2(
		n + 1,
		$author$project$LambdaBasics$VarType(n));
};
var $author$project$Inference$generateFreshVar = function (state0) {
	var nextTypeVar = state0.nextTypeVar;
	var _v0 = $author$project$Inference$newTypeVar(nextTypeVar);
...
var $author$project$Inference$lookupType = F2(
	function (varName, context0) {
		return A2(
			...
			$elm$core$List$head,
			A2($pzp1997$assoc_list$AssocList$get, varName, context0));
	});
...
var $author$project$Inference$getEquations = function (f) {
	return $author$project$StatefulWithErr$get0(
		function (_v0) {
			var equations = _v0.equations;
			return f(equations);
		});
};
...
var $author$project$Inference$updateEquations = function (nextEquations) {
	return $author$project$StatefulWithErr$update(
		function (state) {
			...
			return _Utils_update(
				state,
				{
					equations: nextEquations(equations)
				});
		});
};
var $author$project$Inference$setEquations = function (equations0) {
	return $author$project$Inference$updateEquations(
		function (_v0) {
			return equations0;
		});
};
var $author$project$Inference$ExpectedBoolType = {$: 'ExpectedBoolType'};
var $author$project$Inference$ExpectedNatType = {$: 'ExpectedNatType'};
var $author$project$Inference$ExpectedProductType = {$: 'ExpectedProductType'};
...
var $author$project$Inference$InfiniteType = function (a) {
...
var $author$project$Inference$lookupEquations = $pzp1997$assoc_list$AssocList$get;
...
var $author$project$Inference$expandTypeWithCycleDetection = F3(
	function (type0, seenVars, eqs0) {
		expandTypeWithCycleDetection:
		while (true) {
			switch (type0.$) {
				case 'VarType':
					var n = type0.a;
					if (A2($elm$core$Set$member, n, seenVars)) {
						return $elm$core$Result$Err(
							_List_fromArray(
								[
									$author$project$Inference$InfiniteType(n)
								]));
					} else {
						var _v1 = A2($author$project$Inference$lookupEquations, n, eqs0);
						if (_v1.$ === 'Just') {
							var type1 = _v1.a;
							var $temp$type0 = type1,
								$temp$seenVars = A2($elm$core$Set$insert, n, seenVars),
								$temp$eqs0 = eqs0;
							type0 = $temp$type0;
							seenVars = $temp$seenVars;
							eqs0 = $temp$eqs0;
							continue expandTypeWithCycleDetection;
						} else {
							return $elm$core$Result$Ok(
								$author$project$LambdaBasics$VarType(n));
						}
				...
				case 'Product':
					...
					return A3(
						...
						A3($author$project$Inference$expandTypeWithCycleDetection, type1, seenVars, eqs0),
						A3($author$project$Inference$expandTypeWithCycleDetection, type2, seenVars, eqs0));
				case 'Sum':
					var type1 = type0.a;
					var type2 = type0.b;
					return A3(
				...
				case 'Arrow':
					...
					return A3(
						...
						A3($author$project$Inference$expandTypeWithCycleDetection, type2, seenVars, eqs0));
				case 'LambdaBool':
					return $elm$core$Result$Ok($author$project$LambdaBasics$LambdaBool);
				case 'LambdaNat':
					return $elm$core$Result$Ok($author$project$LambdaBasics$LambdaNat);
				default:
					var type1 = type0.a;
					return A2(
						$elm$core$Result$map,
...
var $author$project$Inference$expandType = F2(
	function (type0, eqs0) {
		return A3($author$project$Inference$expandTypeWithCycleDetection, type0, $elm$core$Set$empty, eqs0);
	});
...
var $author$project$Inference$extendEquations = F3(
	function (varname, type0, eqs) {
		return A3($pzp1997$assoc_list$AssocList$insert, varname, type0, eqs);
	});
var $elm$core$Tuple$pair = F2(
	function (a, b) {
		return _Utils_Tuple2(a, b);
	});
var $author$project$Inference$unification = F3(
	function (type0Unexpanded, type1Unexpanded, eqs0) {
		return A2(
			$elm$core$Result$andThen,
			function (_v0) {
				var type0 = _v0.a;
				var type1 = _v0.b;
				var _v1 = _Utils_Tuple2(type0, type1);
				_v1$2:
				while (true) {
					switch (_v1.a.$) {
						case 'VarType':
							if (_v1.b.$ === 'VarType') {
								var id0 = _v1.a.a;
								var id1 = _v1.b.a;
								return _Utils_eq(id0, id1) ? $elm$core$Result$Ok(
									_Utils_Tuple2(
										eqs0,
										$author$project$LambdaBasics$VarType(id0))) : ((_Utils_cmp(id0, id1) < 0) ? $elm$core$Result$Ok(
									_Utils_Tuple2(
										A3(
											$author$project$Inference$extendEquations,
											id0,
											$author$project$LambdaBasics$VarType(id1),
											eqs0),
										$author$project$LambdaBasics$VarType(id1))) : $elm$core$Result$Ok(
									_Utils_Tuple2(
										A3(
											$author$project$Inference$extendEquations,
											id1,
								...
								return $elm$core$Result$Ok(
									_Utils_Tuple2(
										A3($author$project$Inference$extendEquations, id0, type1, eqs0),
										type1));
							}
						case 'Product':
							switch (_v1.b.$) {
								...
								case 'Product':
									...
									var type10 = _v3.a;
									var type11 = _v3.b;
									var maybeEqs1 = A3($author$project$Inference$unification, type00, type10, eqs0);
									return A2(
										$elm$core$Result$andThen,
										function (_v4) {
											var eqs1 = _v4.a;
											var typeFst = _v4.b;
											var maybeEqs2 = A3($author$project$Inference$unification, type01, type11, eqs1);
											return A2(
												$elm$core$Result$map,
												function (_v5) {
													var eqs2 = _v5.a;
													...
													return _Utils_Tuple2(
														eqs2,
														A2($author$project$LambdaBasics$Product, typeFst, typeSnd));
												},
												maybeEqs2);
										},
										maybeEqs1);
								default:
									...
									return $elm$core$Result$Err(
										_List_fromArray(
											[$author$project$Inference$ExpectedProductType]));
							}
						case 'Arrow':
							switch (_v1.b.$) {
								case 'VarType':
										...
										function (_v9) {
											...
											return A2(
												...
												function (_v10) {
													...
													return _Utils_Tuple2(
														eqs2,
														A2($author$project$LambdaBasics$Arrow, typeFst, typeSnd));
												},
												maybeEqs2);
										},
										maybeEqs1);
								default:
									...
									return $elm$core$Result$Err(
										_List_fromArray(
											[$author$project$Inference$ExpectedArrowType]));
							}
						case 'Sum':
							switch (_v1.b.$) {
								case 'VarType':
										...
										function (_v14) {
											...
											return A2(
												...
												function (_v15) {
													...
													return _Utils_Tuple2(
														eqs2,
														A2($author$project$LambdaBasics$Sum, typeFst, typeSnd));
												},
												maybeEqs2);
										},
										maybeEqs1);
								default:
									...
									return $elm$core$Result$Err(
										_List_fromArray(
											[$author$project$Inference$ExpectedSumType]));
							}
						case 'LambdaBool':
							switch (_v1.b.$) {
								case 'VarType':
								...
								case 'LambdaBool':
									...
									var _v18 = _v1.b;
									return $elm$core$Result$Ok(
										_Utils_Tuple2(eqs0, $author$project$LambdaBasics$LambdaBool));
								default:
									var _v19 = _v1.a;
									return $elm$core$Result$Err(
										_List_fromArray(
											[$author$project$Inference$ExpectedBoolType]));
							}
						case 'LambdaNat':
							switch (_v1.b.$) {
								case 'VarType':
								...
								case 'LambdaNat':
									...
									var _v21 = _v1.b;
									return $elm$core$Result$Ok(
										_Utils_Tuple2(eqs0, $author$project$LambdaBasics$LambdaNat));
								default:
									var _v22 = _v1.a;
									return $elm$core$Result$Err(
										_List_fromArray(
											[$author$project$Inference$ExpectedNatType]));
							}
						default:
							switch (_v1.b.$) {
								case 'VarType':
								...
								case 'LambdaList':
									...
									return A2(
										...
										function (_v23) {
											var eqs1 = _v23.a;
											var typeResult = _v23.b;
											return _Utils_Tuple2(
												eqs1,
												$author$project$LambdaBasics$LambdaList(typeResult));
										},
										A3($author$project$Inference$unification, type00, type11, eqs0));
								default:
									return $elm$core$Result$Err(
										_List_fromArray(
											[$author$project$Inference$ExpectedListType]));
							}
					}
				}
				var id1 = _v1.b.a;
				return $elm$core$Result$Ok(
					_Utils_Tuple2(
						A3($author$project$Inference$extendEquations, id1, type0, eqs0),
						type0));
			},
			A3(
				$elm$core$Result$map2,
				$elm$core$Tuple$pair,
				A2($author$project$Inference$expandType, type0Unexpanded, eqs0),
				A2($author$project$Inference$expandType, type1Unexpanded, eqs0)));
	});
var $author$project$Inference$unify = F2(
	function (type0, type1) {
		return $author$project$Inference$getEquations(
			function (equations0) {
				var _v0 = A3($author$project$Inference$unification, type0, type1, equations0);
				if (_v0.$ === 'Ok') {
					var _v1 = _v0.a;
					var equations1 = _v1.a;
					var intersectionType = _v1.b;
					return A2(
						$author$project$Inference$setEquations,
						equations1,
						$author$project$StatefulWithErr$return(intersectionType));
				} else {
					var errs = _v0.a;
					return $author$project$Inference$throwTypeError(errs);
				}
			});
	});
	...
	switch (term.$) {
		case 'VarUse':
			...
			return $author$project$Inference$getContext(
				function (context0) {
					var _v1 = A2($author$project$Inference$lookupType, varName, context0);
					if (_v1.$ === 'Just') {
						var typeVar = _v1.a;
						return $author$project$StatefulWithErr$return(typeVar);
					} else {
						return A2(
							$author$project$StatefulWithErr$andThen,
							function (typeVar) {
...
var $author$project$Inference$infer0 = function (term) {
	return A2(
		...
		function (_v0) {
			var state = _v0.a;
			var type0 = _v0.b;
			return _Utils_Tuple3(state.context, state.equations, type0);
		},
		A2(
...
var $author$project$TermParser$false = A2(
	...
	$author$project$TermParser$keyword('false'));
...
var $author$project$TermParser$true = A2(
	...
	$author$project$TermParser$keyword('true'));
...
var $author$project$TermParser$leftPattern = A2(
	...
	A2(
		...
		$author$project$TermParser$keyword('left')),
...
var $author$project$TermParser$natConstant = A2($elm$parser$Parser$map, $author$project$LambdaBasics$intToNatTerm, $elm$parser$Parser$int);
...
var $author$project$TermParser$pairPattern = A2(
	...
	A2(
		...
		A2(
			...
			$author$project$TermParser$keyword('pair')),
		$author$project$TermParser$varIntro),
	$author$project$TermParser$varIntro);
...
var $author$project$TermParser$rightPattern = A2(
	...
	A2(
		...
		$author$project$TermParser$keyword('right')),
	$author$project$TermParser$varIntro);
...
function $author$project$TermParser$cyclic$abstraction() {
	var abstractionWithListOfVars = F2(
		function (vars0, body) {
			if (!vars0.b) {
				return A2($author$project$LambdaBasics$Abstraction, '_', body);
			} else {
				if (!vars0.b.b) {
					var _var = vars0.a;
...
function $author$project$TermParser$cyclic$application() {
	var applicationWithListOfArgs = F2(
		function (fn, args0) {
			...
			while (true) {
				if (!args0.b) {
					return A2($author$project$LambdaBasics$Application, fn, $author$project$LambdaBasics$EmptyList);
				} else {
					if (!args0.b.b) {
						var arg = args0.a;
		...
		A2(
			...
			A2(
				...
				A2(
					...
					$author$project$TermParser$keyword('loop-over-list')),
				$elm$parser$Parser$lazy(
					function (_v20) {
						return $author$project$TermParser$cyclic$term();
					})),
		...
		A2(
			...
			A2(
				...
				A2(
					...
					$author$project$TermParser$keyword('loop-over-nat')),
				$elm$parser$Parser$lazy(
					function (_v11) {
						return $author$project$TermParser$cyclic$term();
					})),
...
var $author$project$Main$initModel = function () {
	var input = '(fn { p . (match-pair $p { (pair x y) . $p }) })';
						...
						_Utils_update(
							model,
							{
								evaledTerm: $elm$core$Maybe$Just(
									A2($author$project$Evaluation$eval, $author$project$Evaluation$emptyTermEnvironment, term))
							}));
				} else {
...
var $author$project$Show$showTermEnvironment = function (env) {
	return A2(
		...
		A2(
			...
			$pzp1997$assoc_list$AssocList$toList(env)));
};
			...
			return $elm$core$String$concat(
				_List_fromArray(
					[
						...
						$pzp1997$assoc_list$AssocList$isEmpty(env) ? '(fn { ' : ' |- (fn { ',
						_var,
						' . ',
						$author$project$Show$showTerm(body),
						' })>'
...
var $author$project$Main$view = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$text('example: `(fn { p . (match-pair $p { (pair x y) . $p }) })`'),
										...
										_List_fromArray(
											[
												...
												if (_v2.$ === 'Nothing') {
													...
													if (result.$ === 'Ok') {
														var val = result.a;
														return $author$project$Show$showValue(val);
													} else {
														var err = result.a;
											...
											[
												...
												if (_v4.$ === 'Nothing') {
													...
													if (result.$ === 'Ok') {
														...
														var equations = _v6.b;
														var type0 = _v6.c;
														var _v7 = A2($author$project$Inference$expandType, type0, equations);
														if (_v7.$ === 'Ok') {
															var type1 = _v7.a;
				...
				$mdgriffith$elm_ui$Element$text('  0, 1, 2, 3, ...'),
