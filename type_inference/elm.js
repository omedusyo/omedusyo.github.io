...
{
	if (region.du.ah === region.a5.ah)
	{
		return 'on line ' + region.du.ah;
	}
	return 'on lines ' + region.du.ah + ' through ' + region.a5.ah;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bb: fragment, bh: host, bz: path, bB: port_, bF: protocol, bG: query};
	});
...
var $author$project$Evaluation$EmptyListValue = {$: 0};
var $author$project$Evaluation$ExpectedBoolean = {$: 4};
var $author$project$Evaluation$ExpectedFunction = {$: 2};
var $author$project$Evaluation$ExpectedLeftRight = {$: 3};
var $author$project$Evaluation$ExpectedList = {$: 6};
var $author$project$Evaluation$ExpectedNat = {$: 5};
var $author$project$Evaluation$ExpectedPair = {$: 1};
var $author$project$Evaluation$FalseValue = {$: 5};
...
var $author$project$Evaluation$NatZeroValue = {$: 0};
...
var $author$project$Evaluation$TrueValue = {$: 4};
...
var $author$project$Evaluation$lookupEnvironment = F2(
	function (varName, env) {
		return A2(
			...
			A2($pzp1997$assoc_list$AssocList$get, varName, env));
	});
	...
	function (env, term) {
		switch (term.$) {
			...
			case 3:
				...
				return $elm$core$Result$Ok(
					$author$project$Evaluation$Closure(
						{ad: body, a6: env, bV: _var}));
			case 4:
				var fn = term.a;
				var arg = term.b;
				var _v4 = A2($author$project$Evaluation$eval, env, fn);
				if (!_v4.$) {
					if (_v4.a.$ === 1) {
						var closure = _v4.a.a;
						var _var = closure.bV;
						...
						return A2(
							$elm$core$Result$andThen,
							function (argEvaled) {
								var newEnv = A3($author$project$Evaluation$extendEnvironment, _var, argEvaled, closure.a6);
								return A2($author$project$Evaluation$eval, newEnv, body);
							},
							A2($author$project$Evaluation$eval, env, arg));
					} else {
			...
			case 5:
				...
				return A2(
					$elm$core$Result$map,
					$author$project$Evaluation$LeftValue,
					A2($author$project$Evaluation$eval, env, term1));
			case 6:
				var term1 = term.a;
				return A2(
					$elm$core$Result$map,
					$author$project$Evaluation$RightValue,
					A2($author$project$Evaluation$eval, env, term1));
			case 7:
				var arg = term.a.an;
				var leftVar = term.a.c0;
				var leftBody = term.a.c$;
				var rightVar = term.a.dh;
				var rightBody = term.a.dg;
				return A2(
					$elm$core$Result$andThen,
					function (argEvaled) {
						switch (argEvaled.$) {
							case 2:
								...
								return A2($author$project$Evaluation$eval, newEnv, leftBody);
							case 3:
								var val = argEvaled.a;
								var newEnv = A3($author$project$Evaluation$extendEnvironment, rightVar, val, env);
								return A2($author$project$Evaluation$eval, newEnv, rightBody);
							default:
								return $elm$core$Result$Err(
									_List_fromArray(
			...
			case 10:
				...
				return A2(
					...
					function (argEvaled) {
						switch (argEvaled.$) {
							case 4:
								return A2($author$project$Evaluation$eval, env, leftBody);
							case 5:
								return A2($author$project$Evaluation$eval, env, rightBody);
							default:
								return $elm$core$Result$Err(
									_List_fromArray(
										...
										function (prevVal) {
											var newEnv = A3(
												...
												A3(
													...
													env));
											return A2($author$project$Evaluation$eval, newEnv, loop.ad);
										},
										evalNatLoop(natVal1));
								}
							};
										...
										return A2(
											...
											function (prevVal) {
												var newEnv = A3(
													...
													loop.bP,
													prevVal,
													A3($author$project$Evaluation$extendEnvironment, loop.c1, headValue, env));
												return A2($author$project$Evaluation$eval, newEnv, loop.ad);
											},
											prevResult);
									} else {
...
var $author$project$Inference$emptyState = {D: $author$project$Inference$emptyContext, X: $author$project$Inference$emptyEquations, ay: 0};
var $author$project$LambdaBasics$Arrow = F2(
	function (a, b) {
		return {$: 3, a: a, b: b};
	});
var $author$project$Inference$ExpectedArrowType = {$: 1};
var $author$project$Inference$ExpectedListType = {$: 8};
var $author$project$Inference$ExpectedSumType = {$: 3};
var $author$project$LambdaBasics$LambdaBool = {$: 4};
var $author$project$LambdaBasics$LambdaList = function (a) {
	return {$: 6, a: a};
};
var $author$project$LambdaBasics$LambdaNat = {$: 5};
...
var $author$project$Inference$updateEquations = function (nextEquations) {
	return $author$project$StatefulWithErr$update(
		function (state) {
			var equations = state.X;
			return _Utils_update(
				state,
				{
					X: nextEquations(equations)
				});
		});
};
...
var $author$project$Inference$ExpectedBoolType = {$: 5};
var $author$project$Inference$ExpectedNatType = {$: 2};
var $author$project$Inference$ExpectedProductType = {$: 0};
							...
							$author$project$Inference$updateContext0(
								function (context) {
									return A3(
										...
										loop.bP,
										baseType,
										A3($author$project$Inference$pushVarToContext, loop.cQ, $author$project$LambdaBasics$LambdaNat, context));
								}),
							$author$project$Inference$infer(loop.ad),
							$author$project$Inference$updateContext0(
								function (context) {
									return A2(
										$author$project$Inference$popVarFromContext,
										loop.cQ,
										A2($author$project$Inference$popVarFromContext, loop.bP, context));
								}));
						return A2(
							$author$project$StatefulWithErr$andThen,
																...
																$author$project$Inference$updateContext0(
																	function (context) {
																		return A3(
																			...
																			loop.bP,
																			stateType1,
																			A3($author$project$Inference$pushVarToContext, loop.c1, innerType1, context));
																	}),
																$author$project$Inference$infer(loop.ad),
																$author$project$Inference$updateContext0(
																	function (context) {
																		return A2(
																			$author$project$Inference$popVarFromContext,
																			loop.bP,
																			A2($author$project$Inference$popVarFromContext, loop.c1, context));
																	})));
													}),
...
var $author$project$Inference$infer0 = function (term) {
	return A2(
		...
		function (_v0) {
			var state = _v0.a;
			var type0 = _v0.b;
			return _Utils_Tuple3(state.D, state.X, type0);
		},
		A2(
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {a3: col, bC: problem, bK: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bK, p.a3, p.bC);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{a3: 1, D: _List_Nil, d: 1, b: 0, bK: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$LambdaBasics$EmptyList = {$: 14};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{a3: col, D: s0.D, d: s0.d, b: offset, bK: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.bK, s.a3, s);
	};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {a3: col, cy: contextStack, bC: problem, bK: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bK, s.a3, x, s.D));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.bK, s.a3, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{a3: newCol, D: s.D, d: s.d, b: newOffset, bK: newRow, a: s.a});
	};
};
...
var $author$project$LambdaBasics$BoolFalse = {$: 9};
...
var $elm$parser$Parser$Advanced$keyword = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, kwd, s.b, s.bK, s.a3, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
...
var $author$project$LambdaBasics$BoolTrue = {$: 8};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {a3: col, D: context, d: indent, b: offset, bK: row, a: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3($elm$parser$Parser$Advanced$isSubChar, i.du, s.b, s.a);
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.cT, s.b + 1, s.bK + 1, 1, s.a, s.d, s.D) : A7($elm$parser$Parser$Advanced$varHelp, i.cT, firstOffset, s.bK, s.a3 + 1, s.a, s.d, s.D);
			var name = A3($elm$core$String$slice, s.b, s1.b, s.a);
			return A2($elm$core$Set$member, name, i.de) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
...
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{a8: $elm$parser$Parser$ExpectingVariable, cT: i.cT, de: i.de, du: i.du});
};
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {a3: s.a3 + (newOffset - s.b), D: s.D, d: s.d, b: newOffset, bK: s.bK, a: s.a};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.bK, s.a3 - (floatOffset + s.b), invalid, s.D));
		} else {
...
var $author$project$LambdaBasics$NatZero = {$: 11};
								...
								return $author$project$LambdaBasics$ListLoop(
									{
										an: arg,
										cS: initState,
										bp: {ad: body, c1: listElementVar, bP: stateVar}
									});
							})),
					...
					F2(
						function (arg, _v14) {
							...
							return $author$project$LambdaBasics$MatchProduct(
								{an: arg, ad: body, dU: var0, dV: var1});
						})),
								...
								return $author$project$LambdaBasics$NatLoop(
									{
										an: arg,
										ch: initState,
										bp: {ad: body, cQ: indexVar, bP: stateVar}
									});
							})),
						...
						F3(
							function (arg, _v0, _v1) {
								...
								return $author$project$LambdaBasics$Case(
									{an: arg, c$: leftBody, c0: leftVar, dg: rightBody, dh: rightVar});
							})),
...
var $author$project$Main$initModel = function () {
	...
	return {
		...
		aw: input,
		Q: $elm$core$Maybe$Just(termResult)
	};
}();
var $mdgriffith$elm_ui$Internal$Style$classes = {b3: 'a', aC: 'atv', b5: 'ab', b6: 'cx', b7: 'cy', b8: 'acb', b9: 'accx', ca: 'accy', cb: 'acr', aY: 'al', aZ: 'ar', cc: 'at', aD: 'ah', aE: 'av', ce: 's', cj: 'bh', ck: 'b', cl: 'w7', cn: 'bd', co: 'bdt', ao: 'bn', cp: 'bs', ap: 'cpe', cu: 'cp', cv: 'cpx', cw: 'cpy', B: 'c', ar: 'ctr', as: 'cb', at: 'ccx', C: 'ccy', ae: 'cl', au: 'cr', cx: 'ct', cz: 'cptr', cA: 'ctxt', cH: 'fcs', ba: 'focus-within', cI: 'fs', cJ: 'g', aI: 'hbh', aJ: 'hc', be: 'he', aK: 'hf', bf: 'hfp', cL: 'hv', cN: 'ic', cP: 'fr', ax: 'lbl', cU: 'iml', cV: 'imlf', cW: 'imlp', cX: 'implw', cY: 'it', c_: 'i', bo: 'lnk', Y: 'nb', bs: 'notxt', c6: 'ol', c7: 'or', O: 'oq', db: 'oh', bx: 'pg', by: 'p', dc: 'ppe', di: 'ui', bK: 'r', dk: 'sb', dl: 'sbx', dm: 'sby', dn: 'sbt', dp: 'e', dq: 'cap', dr: 'sev', dx: 'sk', dA: 't', dB: 'tc', dC: 'w8', dD: 'w2', dE: 'w9', dF: 'tj', aA: 'tja', dG: 'tl', dH: 'w3', dI: 'w5', dJ: 'w4', dK: 'tr', dL: 'w6', dM: 'w1', dN: 'tun', bU: 'ts', S: 'clr', dS: 'u', aU: 'wc', b_: 'we', aV: 'wf', b$: 'wfp', aW: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.ce + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bx);
...
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.ce + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bK);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.ce + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dp);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.w)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.ds.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.ds.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.bK) + ('-' + ($elm$core$String$fromInt(pos.a3) + ('-' + ($elm$core$String$fromInt(pos.bZ) + ('-' + $elm$core$String$fromInt(pos.bd)))))));
		case 11:
	...
	[
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cL, $mdgriffith$elm_ui$Internal$Style$classes.O)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cH, $mdgriffith$elm_ui$Internal$Style$classes.O)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ce) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.bK) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ce) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ce) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.bK) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ce) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ar) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aq: closing, j: _List_Nil, G: _List_Nil, u: selector};
	});
					...
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								j: A2(
									$elm$core$List$cons,
									{aq: '\n}', j: _List_Nil, G: props, u: '@supports (' + (prop + (':' + (value + (') {' + parent.u))))},
									rendered.j)
							});
					case 5:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.u + ('{' + (renderValues(rule.G) + (rule.aq + '}')));
		}
	};
		...
		switch (rule.$) {
			...
			case 9:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.bK) + (' / ' + ($elm$core$String$fromInt(position.bK + position.bd) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.a3) + (' / ' + ($elm$core$String$fromInt(position.a3 + position.bZ) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.bK) + ('-' + ($elm$core$String$fromInt(position.a3) + ('-' + ($elm$core$String$fromInt(position.bZ) + ('-' + $elm$core$String$fromInt(position.bd)))))));
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {bd: height / size, Z: size, bX: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cs, adjustment.ci, adjustment.cB, adjustment.c2]);
	var lineHeight = 1.5;
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.ce + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dp))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ce, $mdgriffith$elm_ui$Internal$Style$classes.dp, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.C, $mdgriffith$elm_ui$Internal$Style$classes.cb])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ce, $mdgriffith$elm_ui$Internal$Style$classes.dp, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.C, $mdgriffith$elm_ui$Internal$Style$classes.b9])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ce, $mdgriffith$elm_ui$Internal$Style$classes.dp, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.ca])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ce, $mdgriffith$elm_ui$Internal$Style$classes.dp, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.b8])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.ce + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dA + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aU + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aJ)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.ce + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dA + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aV + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aK)))));
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Y, $mdgriffith$elm_ui$Internal$Style$classes.dp, $mdgriffith$elm_ui$Internal$Style$classes.b3]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Y, $mdgriffith$elm_ui$Internal$Style$classes.dp, $mdgriffith$elm_ui$Internal$Style$classes.ck]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Y, $mdgriffith$elm_ui$Internal$Style$classes.dp, $mdgriffith$elm_ui$Internal$Style$classes.c7]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Y, $mdgriffith$elm_ui$Internal$Style$classes.dp, $mdgriffith$elm_ui$Internal$Style$classes.c6]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Y, $mdgriffith$elm_ui$Internal$Style$classes.dp, $mdgriffith$elm_ui$Internal$Style$classes.cP]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Y, $mdgriffith$elm_ui$Internal$Style$classes.dp, $mdgriffith$elm_ui$Internal$Style$classes.cj]));
						}
					}())
				]),
			_List_fromArray(
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.ce + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.bK + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{cH: $elm$core$Maybe$Nothing, cL: $elm$core$Maybe$Nothing, c3: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.ce, $mdgriffith$elm_ui$Internal$Style$classes.dp]))),
...
var $author$project$Main$InferButtonClicked = {$: 1};
var $author$project$Main$InputChanged = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$RunButtonClicked = {$: 2};
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.at + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.C + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dn + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bs)))))),
						A2(
							$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cx + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ae)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $mdgriffith$elm_ui$Element$Input$negateBox = function (box) {
	return {a$: -box.a$, bn: -box.bn, bJ: -box.bJ, bS: -box.bS};
};
							...
							return _Utils_update(
								els,
								{
									...
									aw: A2(
										$elm$core$List$cons,
										newHeight,
										A2($elm$core$List$cons, newLineHeight, els.aw)),
	...
	function (isMultiline, stacked, attrs) {
		return function (redist) {
			...
			A3(
				...
				{n: _List_Nil, e: _List_Nil, aw: _List_Nil, c: _List_Nil, ab: _List_Nil},
				attrs));
	});
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.bs + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dc)),
										...
										if (_v2.$ === 1) {
											...
											return _List_fromArray(
												[
													...
													A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, redistributed.n, textOptions.dA === ''))
												]);
										}
									}()
									])))),
...
var $mdgriffith$elm_ui$Element$Input$multiline = F2(
	function (attrs, multi) {
		return A3(
			...
			{r: $elm$core$Maybe$Nothing, v: multi.dt, l: $mdgriffith$elm_ui$Element$Input$TextArea},
			attrs,
			{aL: multi.aL, c5: multi.c5, dd: multi.dd, dA: multi.dA});
	});
			...
			return $elm$core$String$concat(
				_List_fromArray(
					[
						...
						loop.bP,
						' . ',
						$author$project$Show$showTerm(loop.ad),
						' })'
					]));
		case 14:
			return 'empty-list';
			...
			[
				...
				_List_fromArray(
					[
						...
						buttonStyle,
						{
							aL: $mdgriffith$elm_ui$Element$text('Run'),
							bu: $author$project$Main$isParsedSuccesfully(model) ? $elm$core$Maybe$Just($author$project$Main$RunButtonClicked) : $elm$core$Maybe$Nothing
						}),
						A2(
						$mdgriffith$elm_ui$Element$Input$button,
						buttonStyle,
						{
							aL: $mdgriffith$elm_ui$Element$text('Infer'),
							bu: $author$project$Main$isParsedSuccesfully(model) ? $elm$core$Maybe$Just($author$project$Main$InferButtonClicked) : $elm$core$Maybe$Nothing
						})
					])),
				A2(
				$mdgriffith$elm_ui$Element$row,
				...
				_List_fromArray(
					[
						...
						{
							aL: $mdgriffith$elm_ui$Element$Input$labelHidden('what is this?'),
							c5: $author$project$Main$InputChanged,
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		...
		dz: $author$project$Main$subscriptions,
